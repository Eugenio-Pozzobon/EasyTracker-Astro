...
% % % DEDICATORIA
\dedicatoria{\input{capitulos/dedicatória}}
% % % %  AGRADECIMENTOS
\agradecimentos{
...
\includegraphics[width=\linewidth]{D:/Git/Easy-Tracker-System/CAD/Fabricação/BDT_G_F_05_v01_desenho}


\chapter{Bill of Materials (BOM)}

\label{apendice:bom}
\includegraphics[width=.95\linewidth]{D:/Git/Easy-Tracker-System/CAD/BOM_v1}
...
\includegraphics[height=.9\linewidth, angle=90]{./periodic}

\section{Testes de Alinhamento}
\label{apendice:alignment}
\includegraphics[height=\linewidth, angle=90]{./alignment}
